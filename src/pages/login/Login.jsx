        ...
        <div className="lg:w-1/2 shadow-2xl bg-base-100 py-20 px-6 rounded-lg">
          <form onSubmit={handleLogin} className="card-body">
            ...
            <div className="form-control mt-7">
              <input className="btn bg-[#FF3811] font-semibold text-xl text-white hover:bg-orange-400" type="submit" value="Login" />
            </div>
          </form>
          <p className='text-[#444] text-center mt-4'>New To Car Doctor ? <Link className='font-medium text-[#FF3811]' to="/signUp">Sign Up</Link></p>
        </div>
      </div>
    </div>
  );
